        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">1. PROSES BISNIS : PEMASARAN PRODUK HILIR</h2>
                    ...
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab4">
                                <img src="{{ url('assets/img/51.png') }}" alt="">
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">2. PROSES BISNIS : MANAJEMEN AGRO WISATA</h2>
                        <h5 style="text-align: center;color: red">PERENCANAAN STRATEGIS</h5>
                        <p style="margin-bottom: 0%"><b><u>DAFTAR SOP</u></b></p>
                        <table class="table table-borderless table-condensed table-hover" style="margin-bottom: 0%">
                            <tr>
                                <td><a href="{{ asset('storage/PTPN IX - SOP MANAJEMEN WISATA AGRO.pdf') }}" target="_blank">SOP Wisata Agro.<br><b>(verifikasi)</b></a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab5">
                                <img src="{{ url('assets/img/53.png') }}" alt="">
                            </div>
                            <div class="tab-pane wizard-ctn" id="tab6">
                                <img src="{{ url('assets/img/54.png') }}" alt="">
                            </div>
                            <div class="wizard-action-pro">
                                <ul class="wizard-nav-ac">
                                    <li><a class="button-first a-prevent" href="javascript:void(0)"><i class="notika-icon notika-more-button"></i></a></li>
