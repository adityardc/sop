...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>PROSES BISNIS : PENGADAAN</h3></p>
        <p class="text-danger"><strong>PENGADAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/pengadaan/35.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/pengadaan/36.png')">
                <div class="carousel-caption d-none d-md-block">
