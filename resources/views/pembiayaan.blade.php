        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">1. PROSES BISNIS : MANAJEMEN KAS KELUAR</h2>
                        <h5 style="text-align: center;color: red">PEMBIAYAAN</h5>
                    ...
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab1">
                                <img src="{{ url('assets/img/29.png') }}" alt="">
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">2. PROSES BISNIS : MANAJEMEN KAS MASUK</h2>
                        <h5 style="text-align: center;color: red">PEMBIAYAAN</h5>
                        <p style="margin-bottom: 0%"><b><u>DAFTAR SOP</u></b></p>
                        <table class="table table-borderless table-condensed table-hover" style="margin-bottom: 0%">
                            <tr>
                    ...
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab2">
                                <img src="{{ url('assets/img/30.png') }}" alt="">
                            </div>
                            <div class="wizard-action-pro">
                                <ul class="wizard-nav-ac">
                                    <li><a class="button-first a-prevent" href="javascript:void(0)"><i class="notika-icon notika-more-button"></i></a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">3. PROSES BISNIS : PENDANAAN</h2>
                        <h5 style="text-align: center;color: red">PEMBIAYAAN</h5>
                        <p style="margin-bottom: 0%"><b><u>DAFTAR SOP</u></b></p>
                        <table class="table table-borderless table-condensed table-hover" style="margin-bottom: 0%">
                            <tr>
                    ...
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab3">
                                <img src="{{ url('assets/img/31.png') }}" alt="">
                            </div>
                            <div class="wizard-action-pro">
                                <ul class="wizard-nav-ac">
                                    <li><a class="button-first a-prevent" href="javascript:void(0)"><i class="notika-icon notika-more-button"></i></a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">4. PROSES BISNIS : <i>CASH POLLING</i></h2>
                        <h5 style="text-align: center;color: red">PEMBIAYAAN</h5>
                        <p style="margin-bottom: 0%"><b><u>DAFTAR SOP</u></b></p>
                        <table class="table table-borderless table-condensed table-hover" style="margin-bottom: 0%">
                            <tr>
                    ...
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab4">
                                <img src="{{ url('assets/img/32.png') }}" alt="">
                            </div>
                            <div class="wizard-action-pro">
                                <ul class="wizard-nav-ac">
                                    <li><a class="button-first a-prevent" href="javascript:void(0)"><i class="notika-icon notika-more-button"></i></a></li>
