...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>1. PROSES BISNIS : MANAJEMEN KAS KELUAR</h3></p>
        <p class="text-danger"><strong>PEMBIAYAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/pembiayaan/29.png')">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>2. PROSES BISNIS : MANAJEMEN KAS MASUK</h3></p>
        <p class="text-danger"><strong>PEMBIAYAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-2" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/pembiayaan/30.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>3. PROSES BISNIS : PENDANAAN</h3></p>
        <p class="text-danger"><strong>PEMBIAYAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-3" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/pembiayaan/31.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>4. PROSES BISNIS : <i>CASH POLLING</i></h3></p>
        <p class="text-danger"><strong>PEMBIAYAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-4" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/pembiayaan/32.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
