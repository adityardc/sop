...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>4. PROSES BISNIS : <i>OPERATIONAL EXCELLENCE</i></h3></p>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>5. PROSES BISNIS : MANAJEMEN PRODUKSI PABRIK</h3></p>
        <p class="text-danger"><strong>TEKNIK dan PENGOLAHAN</strong></p>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>6. PROSES BISNIS : MAINTENANCE PABRIK</h3></p>
        <p class="text-danger"><strong>TEKNIK dan PENGOLAHAN</strong></p>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>7. PROSES BISNIS : INVESTASI DTS</h3></p>
        <p class="text-danger"><strong>TEKNIK dan PENGOLAHAN</strong></p>
    </div>
</div>
<div class="row">
