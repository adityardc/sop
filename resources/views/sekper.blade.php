...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>1. PROSES BISNIS : LAPORAN KEUANGAN TAHUNAN</h3></p>
        <p class="text-danger"><strong>SEKRETARIS PERUSAHAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sekper/3.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/sekper/4.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 2</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/sekper/5.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 3</b></h3>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>2. PROSES BISNIS : PERENCANAAN TAHUNAN</h3></p>
        <p class="text-danger"><strong>SEKRETARIS PERUSAHAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-2" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sekper/6.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/sekper/7.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 2</b></h3>
                </div>
            </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>3. PROSES BISNIS : PERENCANAAN JANGKA PANJANG</h3></p>
        <p class="text-danger"><strong>SEKRETARIS PERUSAHAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-3" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sekper/8.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/sekper/9.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 2</b></h3>
                </div>
            </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>4. PROSES BISNIS : <i>CORPORATE BRANDING</i></h3></p>
        <p class="text-danger"><strong>SEKRETARIS PERUSAHAAN</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-4" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sekper/10.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
