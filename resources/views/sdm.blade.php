...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>1. PROSES BISNIS : HUBUNGAN INDUSTRI</h3></p>
...
<header>
    <div id="carouselExampleIndicators-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sdm/38.png')">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>2. PROSES BISNIS : KAJIAN HUKUM/<i>LEGAL OPINION</i></h3></p>
        <p class="text-danger"><strong>SDM dan UMUM</strong></p>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>3. PROSES BISNIS : HUKUM ASET</h3></p>
        <p class="text-danger"><strong>SDM dan UMUM</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-3" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sdm/40.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>4. PROSES BISNIS : MANAJEMEN KINERJA</h3></p>
        <p class="text-danger"><strong>SDM dan UMUM</strong></p>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>5. PROSES BISNIS : SDM STRATEGIS</h3></p>
        <p class="text-danger"><strong>SDM dan UMUM</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-5" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/sdm/43.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
