...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>1. PROSES BISNIS : OPTIMALISASI ASET NON-CORE OLEH INTERNAL</h3></p>
...
<header>
    <div id="carouselExampleIndicators-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/renstra/45.png')">
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>2. PROSES BISNIS : OPTIMALISASI ASET NON-CORE OLEH EKSTERNAL</h3></p>
        <p class="text-danger"><strong>PERENCANAAN STRATEGIS</strong></p>
    </div>
</div>
<div class="row">
...
<header>
    <div id="carouselExampleIndicators-2" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/renstra/46.png')">
                {{-- <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div> --}}
            </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>3. PROSES BISNIS : TINDAKAN KORPORASI ANAK PERUSAHAAN</h3></p>
        <p class="text-danger"><strong>PERENCANAAN STRATEGIS</strong></p>
    </div>
</div>
{{-- <div class="row">
...
<header>
    <div id="carouselExampleIndicators-3" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active" style="background-image: url('assets/img/renstra/47.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 1</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/renstra/48.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 2</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/renstra/49.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 3</b></h3>
                </div>
            </div>

            <div class="carousel-item" style="background-image: url('assets/img/renstra/50.png')">
                <div class="carousel-caption d-none d-md-block">
                    <h3 style="color: black"><b>STEP 4</b></h3>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-12 text-center">
        <p><h3>4. PROSES BISNIS : PENGEMBANGAN BISNIS</h3></p>
        <p class="text-danger"><strong>PERENCANAAN STRATEGIS</strong></p>
    </div>
</div>
<div class="row">
