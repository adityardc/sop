        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wizard-wrap-int">
                    <div class="wizard-hd">
                        <h2 style="text-align: center">PROSES BISNIS : MANAJEMEN SUSTAINABILITY - SERTIFIKASI</h2>
                        <h5 style="text-align: center;color: red">MANAJEMEN SUSTAINABILITY</h5>
                        ...
                        <table class="table table-borderless table-condensed table-hover" style="margin-bottom: 0%">
                            <tr>
                                <td><a href="{{ asset('storage/PTPN IX - SOP PROSEDUR SERTIFIKASI.pdf') }}" target="_blank">SOP Prosedur Sertifikasi.<br><b>(verifikasi)</b></a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="rootwizard">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane wizard-ctn" id="tab1">
                                <img src="{{ url('assets/img/26.png') }}" alt="">
                            </div>
                            <div class="tab-pane wizard-ctn" id="tab2">
                                <img src="{{ url('assets/img/27.png') }}" alt="">
                            </div>
